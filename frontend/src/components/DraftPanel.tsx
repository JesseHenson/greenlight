...
export default function DraftPanel({ ideaId }: Props) {
  ...
  return (
    <div className="mt-3 border-t border-slate-100 pt-2">
      ...
      {open && (
        <div className="mt-2 space-y-2 bg-slate-50 rounded-md p-3">
          <div className="flex items-center gap-4 text-sm">
            <label className="flex items-center gap-1.5">
              ...
              />
              <span className="text-slate-600">Pros/Cons</span>
            </label>
            <label className="flex items-center gap-1.5">
              <input
                type="checkbox"
            ...
            <label className="flex items-center gap-1.5">
              <input
                type="checkbox"
                checked={draft?.want_impact || false}
                onChange={(e) => handleCheckbox('want_impact', e.target.checked)}
                className="rounded border-slate-300 text-emerald-600"
              />
          ...
          <textarea
            ...
            rows={3}
            className="w-full text-sm border border-slate-200 rounded-md px-3 py-2 focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 resize-none"
          />
